...
namespace AssemblyMetadataAnalyzer
{
    public class Program
    {
        ...
        {
            string assemblyPath = args.Length > 0 ? args[0] : "../task07/bin/Debug/net8.0/task07.dll";
    ...
    public static class AssemblyAnalyzer
    {
        ...
        private static void PrintAttributes(string title, System.Collections.Generic.IEnumerable<Attribute> attributes)
        {
        ...
        private static void PrintMembers<T>(string title, IEnumerable<T> members, Action<T> printDetails) where T : MemberInfo
        {
            Console.WriteLine(title);
