...
public class StudentServiceTests
{
    ...
    public void GroupStudentsByFaculty_ReturnsCorrectFaculty()
    {
        ...
        Assert.True(fitStudents.All(s => s.Faculty == "ФИТ"));

        var econStudents = result["Экономика"].ToList();
        Assert.Single(econStudents);
        Assert.True(econStudents.All(s => s.Faculty == "Экономика"));
    }
